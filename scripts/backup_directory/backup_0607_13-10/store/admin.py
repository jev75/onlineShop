...
from .models import Category, Subcategory, Size, Clothing, Footwear, OtherProduct, Review, ProductImage
...
class ClothingAdmin(admin.ModelAdmin):
    list_display = ['thumbnail_display', 'product_link', 'category', 'genre', 'brand', 'price', 'stock', 'is_on_sale']
    search_fields = ['name', 'description', 'brand']
    autocomplete_fields = ['category', 'sizes']
    list_filter = ['category', 'brand', 'is_on_sale', 'genre']
    ordering = ['name']
    inlines = [ProductImageInline]

    fieldsets = (
        (None, {
            'fields': ['name', 'category', 'genre', 'brand', 'description', 'price', 'stock', 'is_on_sale', 'image']
        }),
        ('Sizes', {
            'fields': ['sizes']
        }),
